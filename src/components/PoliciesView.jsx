...
export default function PoliciesView({ onViewChange }) {
  ...
  return (
    <article className="py-32 px-margin-mobile md:px-margin-desktop relative z-10 max-w-[850px] mx-auto text-left">
      <Reveal>
        {/* Back Button */}
        <button
          onClick={handleBackToHome}
          className="font-body text-label-caps text-champagne-gold hover:text-white transition-colors duration-300 flex items-center gap-2 mb-12 group"
        >
        ...
        {/* Title */}
        <h1 className="font-display text-4xl sm:text-5xl text-ivory-white mb-2 font-semibold">
          Privacy Policy
        </h1>
        <p className="font-body text-sm text-champagne-gold/60 mb-12 font-medium">
          Last updated: July 25, 2026
        </p>

        {/* Body Text */}
        <div className="font-body text-base text-ivory-white/80 space-y-8 leading-relaxed">
          <p>
            The Rawyal operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the &quot;Services&quot;). The Rawyal is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
          </p>
          ...
          {/* Section 1 */}
          <div>
            <h2 className="font-display text-2xl text-champagne-gold mb-4 font-semibold">
            ...
            <ul className="list-disc pl-6 space-y-3">
              <li>
                <strong>Contact details:</strong> including your name, address, billing address, shipping address, phone number, and email address.
              </li>
              <li>
                <strong>Financial information:</strong> including credit card, debit card, and financial account numbers, payment card information, financial account information, transaction details, form of payment, payment confirmation and other payment details.
              </li>
              <li>
                <strong>Account information:</strong> including your username, password, security questions, preferences and settings.
              </li>
              <li>
                <strong>Transaction information:</strong> including the items you view, put in your cart, add to your wishlist, or purchase, return, exchange or cancel and your past transactions.
              </li>
              <li>
                <strong>Communications with us:</strong> including the information you include in communications with us, for example, when sending a customer support inquiry.
              </li>
              <li>
                <strong>Device information:</strong> including information about your device, browser, or network connection, your IP address, and other unique identifiers.
              </li>
              <li>
                <strong>Usage information:</strong> including information regarding your interaction with the Services, including how and when you interact with or navigate the Services.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                <strong>Automatically through the Services:</strong> including from your device when you use our products or services or visit our websites, and through the use of cookies and similar technologies;
              </li>
              <li>
                <strong>From our service providers:</strong> including when we engage them to enable certain technology and when they collect or process your personal information on our behalf;
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <strong className="text-ivory-white block mb-1">Provide, Tailor, and Improve the Services</strong>
              ...
              <li>
                <strong className="text-ivory-white block mb-1">Marketing and Advertising</strong>
              ...
              <li>
                <strong className="text-ivory-white block mb-1">Security and Fraud Prevention</strong>
              ...
              <li>
                <strong className="text-ivory-white block mb-1">Communicating with You</strong>
              ...
              <li>
                <strong className="text-ivory-white block mb-1">Legal Reasons</strong>
          ...
          {/* Section 13 */}
          <div className="pt-6 border-t border-glass-stroke">
            <h2 className="font-display text-2xl text-champagne-gold mb-4 font-semibold">
              Contact
            </h2>
            <p className="mb-4">
              Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call <strong>+91 79 7643 0485</strong> or email us at <strong>bizdev@therawyal.com</strong> or contact us at:
            </p>
            <p className="font-body text-ivory-white/90 font-medium">
              Basement Plot No-2, Bhuvneshwari Vatika A Vistar, Karni Palace Road Panchyawala, 302021 Jaipur RJ, India
            </p>
          </div>
        </div>
        ...
        <button
          onClick={handleBackToHome}
          className="font-body text-label-caps text-champagne-gold hover:text-white transition-colors duration-300 flex items-center gap-2 mt-16 group"
        >
          <span className="material-symbols-outlined text-[16px] group-hover:-translate-x-1 transition-transform duration-300">
            arrow_back
          </span>
